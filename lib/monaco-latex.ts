...
export function registerLatexLanguage(monaco: typeof Monaco) {
  ...
  // Define a dark theme with black/yellow accents
  monaco.editor.defineTheme("latex-dark", {
    ...
    rules: [
      ...
      { token: "keyword.section", foreground: "FFFFFF", fontStyle: "bold" },
      { token: "keyword.formatting", foreground: "AAAAAA" },
      { token: "variable", foreground: "CCCCCC" },
      { token: "variable.math", foreground: "FBBF24" },
      { token: "string.math", foreground: "FBBF24" },
      { token: "string.math.double", foreground: "FBBF24" },
      { token: "string.math.display", foreground: "FBBF24" },
      ...
      { token: "operator.math", foreground: "888888" },
      { token: "number", foreground: "AAAAAA" },
      { token: "identifier.math", foreground: "CCCCCC" },
    ],
    colors: {
